...
- Wave 8 - assignment and COI maturity: backend foundation landed for reviewer invitations, external reviewer delegation approve/reject, conflict graph rows, matching score import, advisory assignment proposal bundles, and override audit; still needs bulk invitation/TPMS import UI, proposal confirm-to-draft flow, richer subject-area matching display, Agent proposal context, and audited override UI.
- Wave 9 - publication and communication maturity: backend foundation landed for email template preview/test-send history, offline review template/preview/confirm, camera-ready metadata submit/accept/reject, publication metadata, and proceedings preview; still needs communication console, offline import UI, real file storage/download, proceedings export/download, DOI/index adapters, and publication workbench.
