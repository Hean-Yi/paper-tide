...
- Wave 6 - configurable conference workflow: backend foundation and reviewer-facing dynamic review form read/render/save/submit loop landed, including saved draft hydration; still needs configurable submission/meta-review/camera-ready form coverage, review revision history, and explicit rebuttal window enforcement.
